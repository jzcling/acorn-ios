...
extension UIBarButtonItem {
    ...
    func setBadge(text: String?, withOffsetFromTopRight offset: CGPoint = CGPoint(x: -8, y: 8), andColor color:UIColor = UIColor.red, andFilled filled: Bool = true, andFontSize fontSize: CGFloat = 11)
    {
