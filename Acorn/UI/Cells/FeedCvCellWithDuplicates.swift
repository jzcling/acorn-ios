...
class FeedCvCellWithDuplicates: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        imageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(openArticle)))
...
extension FeedCvCellWithDuplicates: UICollectionViewDelegate, UICollectionViewDataSource {
